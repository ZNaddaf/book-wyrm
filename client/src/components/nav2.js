...
const NavBar = () => {
  ...
  return (
    <div className="lg:justify-start justify-center flex items-center bg-indigo-900 text-white p-1 font-semibold text-xl tracking-tight" style={{ fontFamily: "cursive" }}>
      <Link to="/">
